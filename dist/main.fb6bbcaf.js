...
function getTotalLocal() {
  ...
  var myChart = new Chart(document.getElementById('getTotal'), config);
} // Get Daily local
...
function getDailyLocal() {
  ...
  var myChart = new Chart(document.getElementById('getDaily'), config);
...
function getTotalWorld() {
  ...
  var myChart = new Chart(document.getElementById('getTotalWorld'), config);
}
...
function getDailyWorld() {
  ...
  var myChart = new Chart(document.getElementById('getDailyWorld'), config);
}
...
},{}]},{},["C:/Users/User/AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","js/main.js"], null)
